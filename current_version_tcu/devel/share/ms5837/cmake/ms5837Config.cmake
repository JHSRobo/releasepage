...
if("TRUE" STREQUAL "TRUE")
  set(ms5837_SOURCE_PREFIX /home/tcu/Github/ROVMIND/ros_workspace/src/ms5837)
  set(ms5837_DEVEL_PREFIX /home/tcu/Github/ROVMIND/ros_workspace/devel)
  set(ms5837_INSTALL_PREFIX "")
  set(ms5837_PREFIX ${ms5837_DEVEL_PREFIX})
else()
  set(ms5837_SOURCE_PREFIX "")
  set(ms5837_DEVEL_PREFIX "")
  set(ms5837_INSTALL_PREFIX /home/tcu/Github/ROVMIND/ros_workspace/install)
...
if(NOT "/home/tcu/Github/ROVMIND/ros_workspace/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ms5837' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tcu/Github/ROVMIND/ros_workspace/src/ms5837/${idir}'.  ${_report}")
    endif()
