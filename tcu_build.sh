...
git clone --branch V2.12 https://github.com/JHSRobo/ROVMIND.git
git clone --branch V3.9 https://github.com/JHSRobo/RPICamera.git
...
git clone --branch V3.5 https://github.com/JHSRobo/keyboard_teleop.git
git clone --branch V1.2 https://github.com/JHSRobo/rov_control_interface.git
