...
git clone --branch V2.5.2 https://github.com/JHSRobo/ROVMIND.git
...
git clone --branch V1.0 https://github.com/JHSRobo/keyboard_teleop.git
...
git clone --branch V1.3 https://github.com/JHSRobo/gpio_control.git
