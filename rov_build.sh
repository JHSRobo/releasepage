...
git clone --branch V2.10 https://github.com/JHSRobo/ROVMIND.git
...
git clone --branch V0.4.1 https://github.com/JHSRobo/copilot_interface.git
...
git clone --branch V0.4.1 https://github.com/JHSRobo/rov_control_interface.git
...
git clone --branch V1.1 https://github.com/JHSRobo/micro_rov.git
git clone --branch V1.1 https://github.com/JHSRobo/drq_ros.git
