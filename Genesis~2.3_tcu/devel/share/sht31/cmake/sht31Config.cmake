...
if("TRUE" STREQUAL "TRUE")
  set(sht31_SOURCE_PREFIX /home/jhsrobo/Github/ROVMIND/ros_workspace/src/sht31)
  set(sht31_DEVEL_PREFIX /home/jhsrobo/Github/ROVMIND/ros_workspace/devel)
  set(sht31_INSTALL_PREFIX "")
  set(sht31_PREFIX ${sht31_DEVEL_PREFIX})
else()
  set(sht31_SOURCE_PREFIX "")
  set(sht31_DEVEL_PREFIX "")
  set(sht31_INSTALL_PREFIX /home/jhsrobo/Github/ROVMIND/ros_workspace/install)
...
if(NOT "/home/jhsrobo/Github/ROVMIND/ros_workspace/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sht31' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jhsrobo/Github/ROVMIND/ros_workspace/src/sht31/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT sht31_NUM_DUMMY_TARGETS)
      set(sht31_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sht31::wrapped-linker-option${sht31_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sht31_NUM_DUMMY_TARGETS "${sht31_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sht31::wrapped-linker-option${sht31_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sht31_LIBRARIES "${interface_target_name}")
